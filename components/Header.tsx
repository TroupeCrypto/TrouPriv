...
index 87107f5ed0c194c588872e1f2d965c74cbd63ef2..3b528348eb4db4fb62c8f6c3ec10555b04a4b589 100644
...
+    const accent = accentColor ?? '#22d3ee';
     ...
     const mainNavItems = [
@@ -72,87 +81,95 @@ const Header: React.FC<HeaderProps> = ({ currentPage, setPage, saveStatus }) =>
